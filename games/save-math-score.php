...
if(isset($_SESSION["user_name"])){
    ...
    if($_POST["data"]){
        ...
        $sql_select = "SELECT * FROM game_scores WHERE user_id ='". $_SESSION['user_id'] ."' AND game_title='Balloon-math-Game'";
        ...
        if($result_select['score'] != null){
            ...
            if($score > $result_select['score']){
                $sql_update = "UPDATE game_scores SET score ='$score' WHERE user_id='". $_SESSION['user_id'] ."' AND game_title='Balloon-math-Game'";
